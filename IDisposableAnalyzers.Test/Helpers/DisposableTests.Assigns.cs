...
namespace N
{
    ...
    internal class C
    {
        internal C(IDisposable disposable)
        {
            ...
            Assert.AreEqual(false, Disposable.Assigns(localOrParameter, new AnalyzerContext(semanticModel, compilation), CancellationToken.None, out _));
        }
...
namespace N
{
    ...
    internal class C
    {
        ...
        internal C(IDisposable disposable)
        {
            ...
            var symbol = semanticModel.GetDeclaredSymbol(value, CancellationToken.None);
            Assert.AreEqual(true, LocalOrParameter.TryCreate(symbol, out var localOrParameter));
            Assert.AreEqual(true, Disposable.Assigns(localOrParameter, new AnalyzerContext(semanticModel, compilation), CancellationToken.None, out var field));
...
namespace N
{
    ...
    public sealed class C : IDisposable
    {
        ...
        public void Dispose()
        {
            ...
            Assert.AreEqual(true, Disposable.Assigns(value, new AnalyzerContext(semanticModel, compilation), CancellationToken.None, out var fieldOrProperty));
